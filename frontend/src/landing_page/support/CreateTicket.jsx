     ...
     <div className="container">
        ...
        <div className="col-4 p-5  mt-2 mb-2">
            <h4 className="mb-4"><i class="fa-solid fa-circle-user"></i> Your Zerodha Account </h4>
                ...
                <a href="/" style={{textDecoration:"none", lineHeight:"2.5"}}>Client Master Report  and Depository Participant</a><br />
        ...
        <div className="col-4 p-5  mt-2 mb-2">
            <h4 className="mb-4"> <i class="fa-solid fa-chart-column"></i>Kite</h4>
        ...
        <div className="col-4 p-5  mt-2 mb-2">
            <h4 className="mb-4"><i class="fa-regular fa-circle-dot"></i> Console </h4>
        ...
        <div className="col-4 p-5  mt-2 mb-2">
            <h4 className="mb-4"><i class="fa-regular fa-circle-half-stroke"></i>Coin </h4>
